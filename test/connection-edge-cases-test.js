...
module.exports['Connection Edge: Write after socket destroyed'] = test => {
    ...
    test.throws(() => {
        client.write('TEST');
    }, /Socket is already closed/, 'Should throw when writing to destroyed socket');
...
module.exports['Connection Edge: Write after logout'] = test => {
    ...
    test.throws(() => {
        client.write('TEST');
    }, /Can not send data after logged out/, 'Should throw when writing after logout');
...
module.exports['Connection Edge: Write with null socket'] = test => {
    ...
    test.throws(() => {
        client.write('TEST');
    }, /Socket is already closed/, 'Should throw when socket is null');
...
module.exports['Connection Edge: Capability update after STARTTLS'] = test => {
    ...
    client.upgradeToSTARTTLS().then(result => {
