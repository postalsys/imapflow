...
class ImapFlow extends EventEmitter {
    ...
    exec(command, attributes, options) {
        ...
        // via setImmediate before the caller's handler is attached. The rejection
    ...
    async connect() {
        ...
        // promise via setImmediate. The rejection still propagates to the caller.
    ...
    getMailboxLock(path, options) {
        ...
        // via setImmediate. The rejection still propagates to the caller.
