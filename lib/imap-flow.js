...
class ImapFlow extends EventEmitter {
    ...
    close() {
        try {
            ...
            // Defer rejections to next tick to allow event handlers to be properly set up
            // This helps prevent unhandled rejections when connection closes unexpectedly
