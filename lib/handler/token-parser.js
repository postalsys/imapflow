...
class TokenParser {
    ...
    async processString() {
        ...
        for (i = 0, len = this.str.length; i < len; i++) {
            ...
            switch (this.state) {
                case 'NORMAL':
                    if (this.expectLiteral8 && chr !== '{') {
                        throw new Error('Unexpected literal8 prefix at position ' + (this.pos + i - 1));
                    }
                    ...
                    switch (chr) {
                        ...
                        case '{':
                            ...
                            this.currentNode.literalType = this.expectLiteral8 ? 'literal8' : 'literal';
                            this.state = 'LITERAL';
                            this.currentNode.closed = false;
                            break;
