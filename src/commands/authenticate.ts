 ...
 */
async function handleAuthError(err: ImapFlowError, errorResponse?: any): Promise<ImapFlowError> {
 ...
 */
async function authOauth(connection: ImapFlow, username: string, accessToken: string): Promise<string> {
    let oauthbearer: string | undefined;
    ...
    try {
        ...
        throw await handleAuthError(err as ImapFlowError, errorResponse);
    }
}
 ...
 * @throws {Error} If authentication fails
 */
async function authLogin(connection: ImapFlow, username: string, password: string): Promise<string> {
 ...
 * @throws {Error} If authentication fails
 */
async function authPlain(connection: ImapFlow, username: string, password: string, authzid?: string | undefined): Promise<string> {
    let errorResponse = false;
    try {
...
export default async function authenticate(
    connection: ImapFlow,
    username: string,
    { accessToken, password, loginMethod, authzid }: AuthenticateCredentials
