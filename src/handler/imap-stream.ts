...
export class ImapStream extends Transform {
                        ...
                        if (payload.length) {
                            ...
                            if (payload.length) {
                                ...
                                await new Promise<void>(resolve => {
                                    ...
                                    const item: ImapStreamItem = { payload, literals, next: resolve, trailingAfterLine };
                                    this.push(item);
                                });
                                this.pendingPush = null;
     ...
     */
    override _transform(chunk: Buffer | string, encoding: BufferEncoding, next: TransformCallback): void {
