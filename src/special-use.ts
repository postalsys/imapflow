...
for (let flag of Object.keys(names)) {
    for (let entry of names[flag]) {
...
export const specialUse = (hasSpecialUseExtension: boolean, folder: SpecialUseFolder): SpecialUseResult => {
